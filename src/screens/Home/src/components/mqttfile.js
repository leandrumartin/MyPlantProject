...
import MqttToRedux from './MqttToRedux';
...
class App_2 extends Component {
  constructor(props) {
    ...
    this.dispatch = props.useDispatch;
  }
  //handle on connect system
  onConnect = () => {
...
export default MqttToRedux(App_2);